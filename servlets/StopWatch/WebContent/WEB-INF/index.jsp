<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" 
    import="com.codingdojo.controllers.Watch, com.codingdojo.models.Timer, java.util.Date, java.text.SimpleDateFormat, java.util.List, java.util.ArrayList" %>
...
<body>
	...
	<h4>Running Time: <%= runningTime %></h4>
